...
assert_contains "$panel_source" 'id: readerNeighborWarmupComponent'
assert_contains "$panel_source" 'id: readerPreviousWarmup'
assert_contains "$panel_source" 'id: readerNextWarmup'
